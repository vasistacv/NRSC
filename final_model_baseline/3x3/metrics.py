...
def print_metrics(results: Dict, title: str = "Evaluation"):
    ...
    for cat in categories:
        ...
        for m in metrics:
            ...
            flag = ""
            if m == "CSI"  and isinstance(val, float) and val > 0.50: flag = " ✓"
            if m == "SEDI" and isinstance(val, float) and val > 0.60: flag = " ✓"
            if m == "FAR"  and isinstance(val, float) and val < 0.30: flag = " ✓"
