...
metrics = [
    ("POD Rain",    -18.7, 0.790, 0.972,   -17.2, 0.954),
    ("CSI Rain",    +17.6, 0.488, 0.415,   +16.5, 0.419),
    ("SEDI Rain",   +60.7, 0.545, 0.339,   +99.6, 0.273),
    ("Correlation",+121.4, 0.543, 0.245,  +167.5, 0.203),
    ("CSI P90",    +303.5, 0.330, 0.082,  +288.2, 0.085),
    ("SEDI P90",   +204.7, 0.692, 0.227,  +220.4, 0.216),
    ("CSI P95",    +290.8, 0.221, 0.056,  +309.3, 0.054),
    ("SEDI P95",  +10220.0, 0.577, 0.006,  +415.2, 0.112),
]
...
imp_ecmwf_clip = [min(v, 420) for v in imp_ecmwf]
bars_e = ax.barh(y_pos + bar_h/2, imp_ecmwf_clip, height=bar_h, color=colors_e,
...
for i, (val, model_v, ecmwf_v, metric_name) in enumerate(
    ...
    if val > 490:
        # Bar exceeds chart xlim → visually clipped at 400, put labels inside
        ax.text(390, i + bar_h/2, f'+{val:.0f}%',
                va='center', ha='right', fontsize=11,
                color='white', fontweight='bold', zorder=5)
        ax.text(190, i + bar_h/2, detail_text,
