...
abstract = (
    ...
    "topographic descriptors and temporal covariates to produce calibrated daily rainfall predictions "
    "at seven automatic weather stations across Telangana during the Indian Summer Monsoon "
    "(June\u2013September, 2015\u20132024). Evaluated under a rigorous Leave-One-Year-Out Cross-Validation "
    ...
    "rainfall events\u2014while requiring fewer than 211,000 trainable parameters. These results "
